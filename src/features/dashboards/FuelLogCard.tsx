  ...
  return (
    <Card>
      <div className="flex flex-col">
        <h3 className="card-content-title text-accent">Cost per km</h3>
      ...
      <BorderLine />
      <div className="flex flex-col">
        <h3 className="card-content-title text-accent">Monthly Cost</h3>
      ...
      <BorderLine />
      <div className="flex flex-col">
        <h3 className="card-content-title text-accent">Avg. Consumption</h3>
